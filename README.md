...
<img width="958" height="414" alt="image" src="https://github.com/user-attachments/assets/0887ef4a-fc01-489c-9b37-aa67cd3429bf" />
...
1. Clone the repository:
   ```bash
   git clone https://github.com/dfirvault/bodyfile-to-csv/bodyfile-to-csv.git
   cd bodyfile-to-csv
   ```
